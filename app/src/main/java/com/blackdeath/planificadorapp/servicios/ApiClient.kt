...
import com.blackdeath.planificadorapp.tipos.LocalDateTimeTypeAdapter
import com.blackdeath.planificadorapp.tipos.LocalDateTypeAdapter
...
object ApiClient {
    ...
    val reportesService: ReportesService = retrofit.create(ReportesService::class.java)
}
